...
type ChainConfig struct {
	...
	THW    *GeecConfig   `json:"thw,omitempty"`
}
...
type GeecConfig struct {
	//xs: config parameters.
	//SGXEnabled bool `json:"SGX"`
	BootstrapNodes []Bootstrap_node_t `json:"bootstrap"`


	//CommitteeRatio int `json:"committee_ratio"`
	//ValidatorRatio int `json:"validator_ratio"`
	//CommitteeTimeout int `json:"committee_timeout"`
	MaxRegPerBlk int `json:"reg_per_blk"`
	RegTimeout int `json:"registration_timeout"`
	ValidateTimeout int `json:"validate_timeout"`
	ElectionTimeout int `json:"election_timeout"`
	BackoffTime 	int `json:"backoff_time"`

	//TxnPerBlk		int `json:"txn_per_blk"`
	//TxnSize			int `json:"txn_size"`
	//BreakDown 		bool `json:"breakdown"`
	//FailureTest		bool `json:"failure_test"` `
}



func (t *GeecConfig) String() string{
	return "Geec"
}
